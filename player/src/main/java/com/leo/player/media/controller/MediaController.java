...
public class MediaController extends FrameLayout implements IMediaController, OrientationUtils.Callback {
    ...
    /** 默认显示超时时间 */
    private static final int DEFALUT_TIMEOUT = 2 * 1000;
    ...
    /** 是否显示全屏按钮 */
    private boolean mShowFullscreenBt = true;
    ...
    private static final String NOT_READY_INFO = "视频在路上，不要急嘛~~";
    ...
    public void setShowFullscreenBt(boolean showFullscreenBt) {
        mShowFullscreenBt = showFullscreenBt;
        if (mBtnFullscreen != null) {
            mBtnFullscreen.setVisibility(showFullscreenBt ? View.VISIBLE : View.GONE);
        }
...
//                show();
        ...
        if(mOutStateChangeListener != null){
            mOutStateChangeListener.notifyPlayState(state);
        }
    }
    ...
    private void initControllerView(View mediaView) {
        ...
        downloadView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                toggleMediaControlsVisiblity();
                if(mOnMoreInfoClickListener != null) {
                    mOnMoreInfoClickListener.onInfoClick(OnMoreInfoClickListener.TYPE_DOWNLOAD);
                }
            }
        });

        seasonView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                toggleMediaControlsVisiblity();
                if(mOnMoreInfoClickListener != null) {
                    mOnMoreInfoClickListener.onInfoClick(OnMoreInfoClickListener.TYPE_SEASON);
                }
            }
        });

        definitionView.setText(definition);
        definitionView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                toggleMediaControlsVisiblity();
                if(mOnMoreInfoClickListener != null){
                    mOnMoreInfoClickListener.onInfoClick(OnMoreInfoClickListener.TYPE_DEFINITION);
                }
            }
        });
    ...
    public void setShowMoreOption(boolean showMoreOption) {
    ...
    public void setOutStateChangeListener(StateChangeListener outStateChangeListener) {
        mOutStateChangeListener = outStateChangeListener;
    }
